...
<template>
	<form :class="cn('h-fit 2xl:w-8/12', 'gap-8', 'flexCol')" @submit="onSubmit">
		...
		<div :class="cn('gap-2', 'flexCenter')">
			<span class="h-[1px] w-full bg-carbon"></span>
			<span>or</span>
			<span class="h-[1px] w-full bg-carbon"></span>
		</div>
		<div :class="cn('gap-4', 'flexCol')">
			<Button shape="roundedNone" variant="solid" type="button" @click="signInWithGithub"
				>Continue with GitHub</Button
			>
			<Button shape="roundedNone" variant="solid" type="button" @click="signInWithGoogle"
