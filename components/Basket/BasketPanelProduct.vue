...
<template>
    <li :class="cn('gap-4', 'flex items-center')">
        ...
        <div :class="cn('h-full w-full', 'flexBetween flexCol')">
            ...
            <div :class="cn('h-fit w-full', 'gap-6', 'flexBetween items-end')">
                <div :class="cn('h-full w-full', 'border border-carbon', 'flexCenter')">
                    <Button @click="decrementQuantity(product.id)" variant="darkGhost" size="full" shape="roundedNone"
                        :class="cn('w-3/12')">
                        -
                    </Button>
        ...
        ">{{ product.quantity }}</span>
                    ...
                    <Button @click="incrementQuantity(product.id)" variant="darkGhost" size="full" shape="roundedNone"
                        :class="cn('w-3/12')">
                        +
                    </Button>
                </div>
