	...
	<div :class="cn('h-full w-full', 'flexCol')">
		...
		<div :class="cn('h-screen w-full')">
			...
			<video :autoplay="true" loop muted
				:class="cn('z-[-1] absolute top-0', 'w-full h-full', 'brightness-50 contrast-125 object-cover')">
				<source src="/videos/ceramics-test.mp4" type="video/mp4">
			</video>

			<div :class="cn('paddingX gap-24 mt-24', 'flexCol')">
				<h1
					:class="cn('z-20', 'flexCol', 'font-heading text-beige', 'text-[clamp(3rem,20vmin,20rem)] leading-none')">
					<span>KLAY</span>
					<span>CRAFT</span>
				</h1>
				...
				<div
					:class="cn('absolute left-0 right-0 bottom-0', 'w-full h-fit', 'mx-auto mb-8 gap-4', '', 'flexCol items-center')">
					<span :class="cn('text-beige')">SCROLL</span>
